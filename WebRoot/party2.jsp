  ...
  <tr> 
    ...
    <td width="485" height="2" valign="top"> 
      ...
      src="vnu_datestamp.js"></script>
        <br>
        <form action="Party2" method="post">       
                                登陆成功！<br>
        <strong> 创建一个聚会:</strong>
        <input type="text" name="party_name" id="party_name"><br/>
        <input type="submit" value="确定"style="background-color:pink">
        <input type="reset" value="重置" style="background-color:red"><br/>
        </form>
        </div>
