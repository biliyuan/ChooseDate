...
daybean db =(daybean)request.getSession().getAttribute("dayInfo");
%>
<html>
<head>
    ...
    <td width="485" height="2" valign="top"> 
      ...
      src="vnu_datestamp.js"></script>
       ...
       <br><strong>聚会：${partyInfo.party_name}</strong>
        <br><strong> 欢迎再次选择日期！</strong> 
        <br><a href="gooddate">选择完毕！查看当前最佳聚会日期！</a>
        ...
        <br><strong> 刚刚您选择的日期：</strong>
        <br><strong><%=db.year%>年<%=db.month%>月<%=db.day%>日</strong>       
        </div>
